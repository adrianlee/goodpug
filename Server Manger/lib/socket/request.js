var Request = function (options) {
    this.id = options.id;
    this.type = Request[options.type];
...
Request.SERVERDATA_AUTH = 0x03;
Request.SERVERDATA_AUTH_RESPONSE = 0x02;
Request.SERVERDATA_EXECCOMMAND = 0x02;
Request.SERVERDATA_RESPONSE_VALUE = 0x00;
